...
<form action="{{ route('teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
    ...
    @method('PUT')
        <div class="relative z-0 mb-6 min-w-[30rem] group mt-5">
            <input type="text" name="name" id="name" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $teacher->name }}" required />
        ...
        <div class="relative z-0 mb-6 min-w-[30rem] group">
            <input type="number" name="nip" id="nip" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $teacher->nip }}" required />
        ...
        <div class="relative z-0 mb-6 min-w-[30rem] group">
            <input type="text" name="address" id="address" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $teacher->address }}" required />
        ...
        <div class="relative z-0 mb-6 min-w-[30rem] group">
            <input type="tel" name="no_telp" id="no_telp" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{ $teacher->no_telp }}" required />
        ...
        <div class="relative z-0 mb-6 min-w-[30rem] group">
            <select id="class_id" name="class_id" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                @if($teacher->class)
                    <option selected value="{{ $teacher->class->id }}"">{{ $teacher->class->name }}</option>
                @else
        ...
        <div class="relative z-0 mb-6 min-w-[30rem] group">
            <input type="email" name="email" id="email" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ $teacher->email }}" placeholder=" "/>
        ...
        <div class="relative z-0 mb-10 min-w-[30rem] group">
            <input type="password" name="password" id="password" class="block py-2.5 px-0 min-w-[30rem] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ $teacher->password }}" placeholder=" "/>
